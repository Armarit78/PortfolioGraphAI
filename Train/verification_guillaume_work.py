...
if __name__=="__main__":
    ...
    data_train = import_csv("intent_dataset.csv")
    ...
    BENCHMARK = [
        ...
        # PRICE (20)
        # =========================
        {"text": "Donne-moi le prix de Apple", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "AAPL"}},
        {"text": "Je veux le prix de Microsoft", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "MSFT"}},
        {"text": "Tu peux me donner le cours de Tesla ?", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "TSLA"}},
        {"text": "Montre-moi le prix de Nvidia", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "NVDA"}},
        {"text": "J’aimerais connaître le prix de Amazon", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "AMZN"}},
        {"text": "Peux-tu me dire combien vaut Apple aujourd’hui ?", "expected_route": "tool",
         "expected_intent": "price", "expected_args": {"symbol": "AAPL"}},
        {"text": "Donne-moi le cours de Meta", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "META"}},
        {"text": "Je veux savoir combien cote alphabet", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "GOOGL"}},
        {"text": "Tu peux me sortir le prix de Tesla maintenant ?", "expected_route": "tool",
         "expected_intent": "price", "expected_args": {"symbol": "TSLA"}},
        {"text": "Dis-moi le prix de Microsoft aujourd’hui", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "MSFT"}},
        {"text": "Apple ça vaut combien là ?", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "AAPL"}},
        {"text": "Je veux le dernier prix de Nvidia", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "NVDA"}},
        {"text": "Montre-moi combien vaut Amazon en ce moment", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "AMZN"}},
        {"text": "Tu peux me dire le cours de AAPL ?", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "AAPL"}},
        {"text": "J’aimerais le prix de MSFT", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "MSFT"}},
        {"text": "Donne-moi le prix de GOOGL", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "GOOGL"}},
        {"text": "Je veux savoir le cours de NVDA", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "NVDA"}},
        {"text": "Peux-tu me donner le prix de Tesla en bourse ?", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "TSLA"}},
        {"text": "Montre-moi le cours de Meta aujourd’hui", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "META"}},
        {"text": "Dis-moi combien vaut Apple en bourse", "expected_route": "tool", "expected_intent": "price",
         "expected_args": {"symbol": "AAPL"}},

        # =========================
        # STATS (20)
        # =========================
        {"text": "Je veux les stats de Apple sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "AAPL", "period": "1y"}},
        {"text": "Donne-moi les statistiques de Microsoft sur 1 an", "expected_route": "tool",
         "expected_intent": "stats", "expected_args": {"symbol": "MSFT", "period": "1y"}},
        {"text": "J’aimerais la volatilité de Tesla sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "TSLA", "period": "1y"}},
        {"text": "Peux-tu me sortir les stats de Nvidia sur 6 mois ?", "expected_route": "tool",
         "expected_intent": "stats", "expected_args": {"symbol": "NVDA", "period": "6mo"}},
        {"text": "Je veux voir la performance de Amazon sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "AMZN", "period": "1y"}},
        {"text": "Montre-moi les stats de Meta", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "META", "period": "1y"}},
        {"text": "Tu peux me donner le rendement de alphabet sur 1 an ?", "expected_route": "tool",
         "expected_intent": "stats", "expected_args": {"symbol": "GOOGL", "period": "1y"}},
        {"text": "Je veux la volatilité de Apple sur 6 mois", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "AAPL", "period": "6mo"}},
        {"text": "Donne-moi les performances de Tesla sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "TSLA", "period": "1y"}},
        {"text": "J’aimerais les stats de MSFT sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "MSFT", "period": "1y"}},
        {"text": "Peux-tu me dire le Sharpe ratio de Nvidia ?", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "NVDA", "period": "1y"}},
        {"text": "Je veux les statistiques de Amazon sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "AMZN", "period": "1y"}},
        {"text": "Montre-moi la performance de Meta sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "META", "period": "1y"}},
        {"text": "Tu peux me sortir les stats de GOOGL sur 6 mois ?", "expected_route": "tool",
         "expected_intent": "stats", "expected_args": {"symbol": "GOOGL", "period": "6mo"}},
        {"text": "Donne-moi le rendement annualisé de Tesla", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "TSLA", "period": "1y"}},
        {"text": "Je veux la volatilité de Microsoft", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "MSFT", "period": "1y"}},
        {"text": "J’aimerais les stats de Apple sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "AAPL", "period": "1y"}},
        {"text": "Peux-tu me montrer la performance de Nvidia sur 1 an ?", "expected_route": "tool",
         "expected_intent": "stats", "expected_args": {"symbol": "NVDA", "period": "1y"}},
        {"text": "Je veux les indicateurs de Amazon sur 6 mois", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "AMZN", "period": "6mo"}},
        {"text": "Dis-moi les stats de Tesla sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "TSLA", "period": "1y"}},
        ...
        {"text": "Fais-moi une comparaison entre Amazon et Meta", "expected_route": "tool",
        ...
        {"text": "Je veux comparer alphabet et Amazon sur 6 mois", "expected_route": "tool",
         "expected_intent": "compare",
        ...
        {"text": "J’aimerais une comparaison Amazon contre Apple", "expected_route": "tool",
         "expected_intent": "compare",
        ...
        # SCREENER (20)
        # =========================
        {"text": "Je veux des actions européennes dans la santé", "expected_route": "tool",
        ...
        {"text": "Je veux un portefeuille d’actions hors énergie", "expected_route": "tool",
         "expected_intent": "screener",
        ...
        {"text": "Montre-moi des actions européennes dans le luxe", "expected_route": "tool",
         "expected_intent": "screener",
        ...
        {"text": "Je cherche des actions santé avec dividendes", "expected_route": "tool",
         "expected_intent": "screener",
        ...
        # CHAT (20)
        # =========================
        {"text": "C’est quoi un ETF exactement ?", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Explique-moi ce qu’est la volatilité", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Je veux comprendre ce qu’est un dividende", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Peux-tu m’expliquer le Sharpe ratio ?", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "J’aimerais comprendre la diversification", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Dis-moi simplement ce qu’est une action", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Explique-moi la différence entre action et obligation", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "Je veux comprendre le bêta en bourse", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Tu peux m’expliquer ce qu’est le PER ?", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "J’aimerais savoir ce qu’est un rendement annualisé", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "Peux-tu m’expliquer la capitalisation boursière ?", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "Je veux comprendre la différence entre ETF et action", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "Explique-moi ce qu’est un portefeuille défensif", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "Dis-moi ce que veut dire drawdown", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Je veux une explication simple du risque en bourse", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "Peux-tu m’expliquer ce qu’est un ETF distribuant ?", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "J’aimerais comprendre ce qu’est un ETF capitalisant", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "Explique-moi la différence entre croissance et value", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "Je veux comprendre comment lire une performance sur un an", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
        {"text": "Tu peux m’expliquer pourquoi une action monte ou baisse ?", "expected_route": "chat",
         "expected_intent": "unknown", "expected_args": {}},
    ...
    BENCHMARK2 = [
        ...
        {"text": "Quel est le Sharpe ratio de Tesla sur 1 an ?", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "TSLA", "period": "1y"}},
        {"text": "Montre-moi les performances de Nvidia sur 5 ans", "expected_route": "tool",
        ...
        {"text": "Affiche les stats de Amazon sur 1 an", "expected_route": "tool", "expected_intent": "stats",
         "expected_args": {"symbol": "AMZN", "period": "1y"}},
        {"text": "Je veux voir la performance de Google sur 5 ans", "expected_route": "tool",
         "expected_intent": "stats",
        ...
        {"text": "Montre-moi la comparaison entre Apple et Meta", "expected_route": "tool",
         "expected_intent": "compare",
        ...
        {"text": "Fais-moi une comparaison entre Tesla et Google", "expected_route": "tool",
         "expected_intent": "compare",
         "expected_args": {"symbol1": "TSLA", "symbol2": "GOOGL", "period": "1y"}},
        ...
        # SCREENER (20)
        # =========================
        {"text": "Je cherche des actions technologiques en Europe", "expected_route": "tool",
         "expected_intent": "screener",
         "expected_args": {"description": "Je cherche des actions technologiques en Europe"}},
        {"text": "Trouve-moi des actions de santé aux États-Unis", "expected_route": "tool",
         "expected_intent": "screener",
        ...
        {"text": "Je cherche des actions industrielles en Europe", "expected_route": "tool",
         "expected_intent": "screener",
         "expected_args": {"description": "Je cherche des actions industrielles en Europe"}},
        {"text": "Trouve des actions tech avec croissance élevée", "expected_route": "tool",
         "expected_intent": "screener",
        ...
        {"text": "Trouve des actions avec faible bêta en Europe", "expected_route": "tool",
         "expected_intent": "screener",
         "expected_args": {"description": "Trouve des actions avec faible bêta en Europe"}},
        {"text": "Je veux des actions de technologie sans énergie", "expected_route": "tool",
         "expected_intent": "screener",
         "expected_args": {"description": "Je veux des actions de technologie sans énergie"}},
        {"text": "Montre-moi des actions de santé avec dividendes", "expected_route": "tool",
         "expected_intent": "screener",
         "expected_args": {"description": "Montre-moi des actions de santé avec dividendes"}},
        {"text": "Je veux un portefeuille d’actions industrielles", "expected_route": "tool",
         "expected_intent": "screener",
        ...
        {"text": "Explique-moi ce qu'est la volatilité en bourse", "expected_route": "chat",
         "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Comment fonctionne le marché boursier ?", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "C'est quoi un dividende ?", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        ...
        {"text": "Pourquoi les actions montent et descendent ?", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Explique-moi ce qu'est un portefeuille équilibré", "expected_route": "chat",
         "expected_intent": "unknown",
         "expected_args": {}},
        ...
        {"text": "Comment fonctionne un indice boursier ?", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
        {"text": "Qu'est-ce que le S&P 500 ?", "expected_route": "chat", "expected_intent": "unknown",
         "expected_args": {}},
    ...
    BENCHMARK3 = [
        ...
        {"text": "Je veux un portefeuille d’actions européennes dans la santé sans la France",
         ...
         "expected_args": {
             "description": "Je veux un portefeuille d’actions européennes dans la santé sans la France"}},

        {"text": "Construis-moi un screener d’actions US hors technologie avec faible volatilité",
         "expected_route": "tool", "expected_intent": "screener",
         "expected_args": {
             "description": "Construis-moi un screener d’actions US hors technologie avec faible volatilité"}},
        ...
        {"text": "Je veux un portefeuille actions Europe avec faible bêta hors France et hors Allemagne",
         "expected_route": "tool", "expected_intent": "screener",
         "expected_args": {
             "description": "Je veux un portefeuille actions Europe avec faible bêta hors France et hors Allemagne"}},

        {"text": "Portefeuille ETF bien classé avec performance rating de 4 ou 5 et risk rating de 1 ou 2",
         "expected_route": "tool", "expected_intent": "screener",
         "expected_args": {
             "description": "Portefeuille ETF bien classé avec performance rating de 4 ou 5 et risk rating de 1 ou 2"}},
    ...
    BENCHMARK4 = [
        ...
        {"text": "Trouve des actions comme Nvidia",
         "expected_route": "tool", "expected_intent": "screener",
         "expected_args": {"description": "Trouve des actions comme Nvidia"}},
        ...
        {"text": "Entre Apple et Tesla, lequel est le plus performant ?",
         "expected_route": "tool", "expected_intent": "compare",
         "expected_args": {"period": "1y"}},
    ]

    BENCHTOTAL = BENCHMARK + BENCHMARK2 + BENCHMARK3 + BENCHMARK4

    nb_doublon = 0
    bench_size = len(BENCHTOTAL)
    train_size = len(data_train)

    for test in BENCHTOTAL:
        for train_row in data_train:
            if test["text"].lower().strip() == train_row["text"].lower().strip():
                nb_doublon += 1
                break

    print(f"Taille du dataset de training : {train_size}")
    print(f"Nombre de tests du benchmark : {bench_size}")
    print(f"Nombre de tests du benchmark dans les données de training : {nb_doublon}/{bench_size}")
    print(f"Part des tests du benchmark dans les données de training : {nb_doublon/bench_size*100:.2f}%")
